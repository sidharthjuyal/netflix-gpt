const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-full aspect-video xl:pt-[13%] lg:pt-[10%] md:pt-[10%] pt-[7.5%] absolute px-6 md:px-24 bg-gradient-to-r from-black">
      ...
      <div className="text-white py-6 xl:text-md lg:text-sm md:text-xs text-xs w-3/4 md:w-1/2">{overview}</div>
      <div>
        <button className="hover:opacity-[0.85] bg-white text-black py-2 px-4 md:py-2 md:px-10 xl:text-lg lg:text-md md:text-sm text-xs rounded-lg">▷ Play</button>
